...
|--------|-------------------------------|--------------|----------------------|----------------------------------------|---------------------------------------------------------------|
| GET    | http://localhost:8080/api/doctors   | 200 OK       | Get All Doctors      |                                        | [\n    {\n        "dr_id": 1,\n        "dname": "Dr. Smith",\n        "phone": 123456789,\n        "insurance_id": 12345,\n        "email": "drsmith@example.com",\n        "dob": "1980-01-01"\n    },\n    {\n        "dr_id": 2,\n        "dname": "Dr. Johnson",\n        "phone": 987654321,\n        "insurance_id": 54321,\n        "email": "drjohnson@example.com",\n        "dob": "1975-05-10"\n    }\n] |
| GET    | http://localhost:8080/api/doctors/1 | 200 OK       | Get doctor by id     |                                        | {\n    "dr_id": 1,\n    "dname": "Dr. Smith",\n    "phone": 123456789,\n    "insurance_id": 12345,\n    "email": "drsmith@example.com",\n    "dob": "1980-01-01"\n} |
| POST   | http://localhost:8080/api/doctors   | 201 Created  | Create new doctor    | {\r\n    "dname": "Dr. Smith",\r\n    "phone": 123456789,\r\n    "insurance_id": 12345,\r\n    "email": "drsmith@example.com",\r\n    "dob": "1980-01-01"\r\n} | {\n    "dr_id": 3,\n    "dname": "Dr. Smith",\n    "phone": 123456789,\n    "insurance_id": 12345,\n    "email": "drsmith@example.com",\n    "dob": "1980-01-01"\n} |
| PUT    | http://localhost:8080/api/doctors/1 | 200 OK       | Update existing doctor with id | {\r\n    "dname": "Dr. ahmad",\r\n    "phone": 123456789\r\n} | {\n    "dr_id": 1,\n    "dname": "Dr. ahmad",\n    "phone": 123456789,\n    "insurance_id": 0,\n    "email": null,\n    "dob": null\n} |
| DELETE | http://localhost:8080/api/doctors/3 | 200 OK       | Delete doctor by id  |                                        | "Deleted successfully."                                        |
| Method | URL                           | HTTP Status | Description                  | Sample Request                                                         | Sample Response                                                                                                                   |
|--------|-------------------------------|--------------|------------------------------|------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
